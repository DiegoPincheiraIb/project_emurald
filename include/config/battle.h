...
// Enemy trainer evolution settings
#define B_ENEMY_RANDOM_EVO_IGNORE_ITEMS TRUE       // If TRUE, enemy trainer mons can pick random branch evolutions without requiring held/evolution items.
