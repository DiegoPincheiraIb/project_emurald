...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_SPRIGATITO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_FLORAGATO}),
    },
    ...
    [SPECIES_FLORAGATO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 64, SPECIES_MEOWSCARADA}),
    },
    ...
    [SPECIES_GREAVARD] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_HOUNDSTONE}),
    },
