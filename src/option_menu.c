...
static const u8 *const sOptionMenuItemsNames[MENUITEM_COUNT] =
{
    ...
    [MENUITEM_SKIPINTRO] = gText_SkipIntro,
...
static void SkipIntro_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_SkipIntroNo, 104, YPOS_SKIPINTRO, styles[0]);
    DrawOptionMenuChoice(gText_SkipIntroYes, GetStringRightAlignXOffset(FONT_SHORT, gText_SkipIntroYes, 198), YPOS_SKIPINTRO, styles[1]);
}
...
static void DrawOptionMenuTexts(void)
{
    ...
    for (i = 0; i < MENUITEM_COUNT; i++)
        AddTextPrinterParameterized(WIN_OPTIONS, FONT_NORMAL, sOptionMenuItemsNames[i], 8, (i * 13) + 1, TEXT_SKIP_DRAW, NULL);
    CopyWindowToVram(WIN_OPTIONS, COPYWIN_FULL);
}
