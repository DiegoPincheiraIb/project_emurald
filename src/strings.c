...
const u8 gText_DefaultNameRuby[] = _("Ruby");
const u8 gText_DefaultNameMay[] = _("May");
const u8 gText_DefaultNameSapphy[] = _("Sapphy");
...
const u8 gText_PkmnNeedsToReplaceMove[] = _("Should {STR_VAR_1} replace a current\nmove with {STR_VAR_2}?");
...
const u8 gText_SkipIntroYes[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}YES");
const u8 gText_SkipIntroNo[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NO");
