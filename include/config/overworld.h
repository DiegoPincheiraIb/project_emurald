...
#define OW_SEASONAL_LAND_ENCOUNTERS     TRUE         // If TRUE, land encounter slot selection may vary by season using custom hack logic. Keep FALSE to preserve upstream land slot behavior.
