...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_YAMPER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_BOLTUND}),
    },
    ...
    [SPECIES_SIZZLIPEDE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_CENTISKORCH}),
    },
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                      \
    ...
    [SPECIES_SNOM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 44, SPECIES_FROSMOTH}),
    },
