...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_ROWLET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_DARTRIX}),
    },
    ...
    [SPECIES_DARTRIX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 60, SPECIES_DECIDUEYE}),
    },
    ...
    [SPECIES_BOUNSWEET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_STEENEE}),
    },
    ...
    [SPECIES_STEENEE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 60, SPECIES_TSAREENA}),
    },
