...
const struct Berry gBerries[] =
{
    [ITEM_CHERI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .size = 20,
        .maxYield = YIELD_RATE(17, 18, 19, 20),
        .minYield = YIELD_RATE(5, 6, 6, 7),
        ...
        .growthDuration = GROWTH_DURATION(5, 5, 5, 5, 5, 5),
        .spicy = 10,
        .dry = 0,
        .sweet = 0,
        .bitter = 0,
    ...
    [ITEM_RAZZ_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 120,
        .maxYield = YIELD_RATE(16, 17, 18, 19),
        .minYield = YIELD_RATE(4, 5, 6, 6),
    ...
    [ITEM_POMEG_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 135,
        .maxYield = YIELD_RATE(15, 16, 17, 18),
    ...
    [ITEM_CORNN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_PURPLE,
        .size = 75,
        .maxYield = YIELD_RATE(14, 15, 16, 17),
        .minYield = YIELD_RATE(3, 4, 4, 5),
    ...
    [ITEM_SPELON_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 133,
        .maxYield = YIELD_RATE(13, 14, 15, 16),
    ...
    [ITEM_LANSAT_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 97,
        .maxYield = YIELD_RATE(13, 13, 14, 15),
