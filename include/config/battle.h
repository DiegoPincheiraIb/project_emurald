...
#define B_INTRO_SLIDE_SPEED                 4     // Controls how fast the slide animation plays at the start of a battle. The original vanilla value is 2. Higher values = faster animation (default 4 = 2x faster than vanilla).
