...
static const struct TrainerTeamMon sYoungsterMonPool[] =
{
    ...
    CLASS_POOL_MON_SPECIES(SPECIES_YAMPER),
    CLASS_POOL_MON_SPECIES(SPECIES_NINCADA),
    CLASS_POOL_MON_SPECIES(SPECIES_SNIVY),
    CLASS_POOL_MON_SPECIES(SPECIES_OSHAWOTT),
};

static const struct TrainerTeamMon sLassMonPool[] =
{
    CLASS_POOL_MON_SPECIES(SPECIES_BIDOOF),
    CLASS_POOL_MON_SPECIES(SPECIES_SMOLIV),
    CLASS_POOL_MON_SPECIES(SPECIES_YAMPER),
    CLASS_POOL_MON_SPECIES(SPECIES_SPRIGATITO),
    CLASS_POOL_MON_SPECIES(SPECIES_COTTONEE),
    CLASS_POOL_MON_SPECIES(SPECIES_OSHAWOTT),
};

static const struct TrainerTeamMon sBugCatcherMonPool[] =
{
    CLASS_POOL_MON_SPECIES(SPECIES_FLETCHLING),
    CLASS_POOL_MON_SPECIES(SPECIES_LEDYBA),
    CLASS_POOL_MON_SPECIES(SPECIES_ROWLET),
    CLASS_POOL_MON_SPECIES(SPECIES_PARAS),
    CLASS_POOL_MON_SPECIES(SPECIES_DWEBBLE),
    CLASS_POOL_MON_SPECIES(SPECIES_JOLTIK),
    CLASS_POOL_MON_SPECIES(SPECIES_WINGULL),
};

static const struct TrainerTeamMon sFishermanMonPool[] =
{
    CLASS_POOL_MON_SPECIES(SPECIES_FEEBAS),
    CLASS_POOL_MON_SPECIES(SPECIES_HORSEA),
    CLASS_POOL_MON_SPECIES(SPECIES_WOOPER),
    CLASS_POOL_MON_SPECIES(SPECIES_CHINCHOU),
    CLASS_POOL_MON_SPECIES(SPECIES_TOTODILE),
    CLASS_POOL_MON_SPECIES(SPECIES_WINGULL),
};

static const struct TrainerTeamMon sTeamAquaGruntMonPool[] =
{
    CLASS_POOL_MON_SPECIES(SPECIES_CARVANHA),
    CLASS_POOL_MON_SPECIES(SPECIES_GULPIN),
    CLASS_POOL_MON_SPECIES(SPECIES_ZUBAT),
    CLASS_POOL_MON_SPECIES(SPECIES_CHEWTLE),
    CLASS_POOL_MON_SPECIES(SPECIES_TOTODILE),
    CLASS_POOL_MON_SPECIES(SPECIES_REMORAID),
    CLASS_POOL_MON_SPECIES(SPECIES_CORPHISH),
};

static const struct TrainerTeamMon sLadyMonPool[] =
{
    CLASS_POOL_MON_SPECIES(SPECIES_PSYDUCK),
    CLASS_POOL_MON_SPECIES(SPECIES_CHIKORITA),
    CLASS_POOL_MON_SPECIES(SPECIES_EEVEE),
    CLASS_POOL_MON_SPECIES(SPECIES_BOUNSWEET),
    CLASS_POOL_MON_SPECIES(SPECIES_TOGEDEMARU),
    CLASS_POOL_MON_SPECIES(SPECIES_SWABLU),
};

static const struct TrainerTeamMon sRichBoyMonPool[] =
{
    CLASS_POOL_MON_SPECIES(SPECIES_MAGBY),
    CLASS_POOL_MON_SPECIES(SPECIES_ELEKID),
    CLASS_POOL_MON_SPECIES(SPECIES_SNUBBULL),
    CLASS_POOL_MON_SPECIES(SPECIES_EEVEE),
    CLASS_POOL_MON_SPECIES(SPECIES_MEOWTH),
    CLASS_POOL_MON_SPECIES(SPECIES_SWABLU),
};
